...
## Stage 3: docs/ チェック（コード変更時）

`docs/`が存在する場合、以下の対応表に基づいてドキュメント更新の必要性を確認：

| 変更の種類 | 確認対象ドキュメント |
|-----------|-------------------|
| 公開関数のシグネチャ変更 | `docs/api-reference/` |
| 新規モジュール/ディレクトリ追加 | `docs/architecture.md` |
| CLI引数/コマンド変更 | `docs/usage-guide/` |
| 新しいコーディングパターン導入 | `docs/code-patterns/` |
